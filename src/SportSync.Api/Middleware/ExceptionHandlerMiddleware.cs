...
using sport_sync.Contracts;
using SportSync.Domain.Core.Errors;
using SportSync.Domain.Core.Exceptions;

namespace sport_sync.Middleware;
...
internal class ExceptionHandlerMiddleware
{
    ...
    private static (HttpStatusCode httpStatusCode, IReadOnlyCollection<SportSync.Domain.Core.Primitives.Error>) GetHttpStatusCodeAndErrors(Exception exception) =>
        exception switch
        {
