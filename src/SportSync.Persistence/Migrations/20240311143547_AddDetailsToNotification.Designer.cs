...
namespace SportSync.Persistence.Migrations
{
    ...
    [Migration("20240311143547_AddDetailsToNotification")]
    partial class AddDetailsToNotification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportSync.Domain.Entities.Notification", b =>
                {
                    ...
                    b.OwnsOne("SportSync.Domain.ValueObjects.NotificationDetails", "Details", b1 =>
                        {
