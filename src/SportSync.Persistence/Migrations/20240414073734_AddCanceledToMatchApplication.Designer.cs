...
namespace SportSync.Persistence.Migrations
{
    ...
    [Migration("20240414073734_AddCanceledToMatchApplication")]
    partial class AddCanceledToMatchApplication
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportSync.Domain.Entities.MatchAnnouncement", b =>
                {
                    ...
                    b.Property<int>("AcceptedPlayersCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("SportSync.Domain.Entities.Player", b =>
                {
                    ...
                    b.Property<bool>("HasAnnouncedMatch")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("SportSync.Domain.Entities.MatchAnnouncement", b =>
                {
                    b.HasOne("SportSync.Domain.Entities.Match", null)
                        ...
                        .HasForeignKey("SportSync.Domain.Entities.MatchAnnouncement", "MatchId")
